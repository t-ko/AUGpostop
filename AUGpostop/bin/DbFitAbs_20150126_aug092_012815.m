...
prefix='BFI_012815'; %UPDATE to match BFI data prefix
analysisID='BFI_012815abs_fitavg'; %<abs> if fit with FD-DOS, <fitavg> if averaging detectors
absID='absolutes_012815'; %UPDATE to match FD-DOS data directory
