...
prefix='BFI_012915'; %UPDATE to match BFI data prefix
analysisID='BFI_012915abs_fitavg'; %<abs> if fit with FD-DOS, <fitavg> if averaging detectors
absID='absolutes_012915!'; %UPDATE to match FD-DOS data directory
...
regionmarks = {[3 4];[5 6];[1 2];[7 8]}; % leave empty cell {} if no region discrimination
