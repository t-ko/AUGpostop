...
%% FILENAME PARAMETERS
studyID='AUG092_012615'; %UPDATE to match data directory
prefix='BFI_013015'; %UPDATE to match BFI data prefix
analysisID='BFI_013015abs_fitavg'; %<abs> if fit with FD-DOS, <fitavg> if averaging detectors
absID='absolutes_013015!'; %UPDATE to match FD-DOS data directory
...
regionmarks = {[5 6];[3 4];[7 8];[1 2]}; % leave empty cell {} if no region discrimination
