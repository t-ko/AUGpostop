...
prefix='BFI_020715'; %UPDATE to match BFI data prefix
analysisID='BFI_020715abs_fitavg'; %<abs> if fit with FD-DOS, <fitavg> if averaging detectors
absID='absolutes_020715'; %UPDATE to match FD-DOS data directory
