...
prefix='BFI_020915'; %UPDATE to match BFI data prefix
analysisID='BFI_020915abs_fitavg'; %<abs> if fit with FD-DOS, <fitavg> if averaging detectors
absID='absolutes_020915'; %UPDATE to match FD-DOS data directory
