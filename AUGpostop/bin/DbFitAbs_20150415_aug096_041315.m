...
prefix='BFI_041515';
analysisID='BFI_041515abs_fitavg';
absID='absolutes_041515';
%Extension added to filename, if nothing, just use ext='';
exten={''};

%% DCS PARAMETERS
s=1; %source select, 1 or 2
usedflowdets=[3 4 5 6 7 8];%must be consecutive, cannot be ex. 1,3,4 or 2,4.  must change code if this is the case 
fitavg = 1; %average all usedflowdets during correlation fitting?
regionmarks = {[1 2],[4 5]}; % leave empty cell {} if no region discrimination
