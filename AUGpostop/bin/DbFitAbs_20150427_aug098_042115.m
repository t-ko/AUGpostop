...
prefix='BFI_042715';
analysisID='BFI_042715abs_fitavg';
absID='absolutes_042715!';
...
regionmarks = {[1 2],[4 5],[6 7]}; % leave empty cell {} if no region discrimination
...
Ns=1;
Nd=8;
SDS=[2.5 2.5 2.5 2.5 2.5 2.5 2.5 2.5];
