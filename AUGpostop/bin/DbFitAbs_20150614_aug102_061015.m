...
prefix='BFI_061415';
analysisID='BFI_061415abs_fitavg';
absID='absolutes_061415';
%Extension added to filename, if nothing, just use ext='';
exten={''};

%% DCS PARAMETERS
s=1; %source select, 1 or 2
usedflowdets=[1 2 3 4 5 6 7];%must be consecutive, cannot be ex. 1,3,4 or 2,4.  must change code if this is the case 
fitavg = 1; %average all usedflowdets during correlation fitting?
regionmarks = {[3 4],[1 2]}; % leave empty cell {} if no region discrimination
...
Ns=1;
Nd=8;
SDS=[2.5 2.5 2.5 2.5 2.5 2.5 2.5 0.8];
