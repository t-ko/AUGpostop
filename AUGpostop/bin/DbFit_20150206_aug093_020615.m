...
prefix='BFI_5'; %UPDATE to match BFI data prefix
analysisID='BFI_020615_fitavg'; %<abs> if fit with FD-DOS, <fitavg> if averaging detectors
absID=''; %UPDATE to match FD-DOS data directory, leave BLANK if assuming properties
