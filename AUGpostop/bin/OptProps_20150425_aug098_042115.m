...
groups={[1 3 5];[2 4 6];[7 8 9 10 11 12];[17];[13 14 15 16]};
grouplabels={'Calibration block';'Check block';'Left Forehead';'Right Forehead';'Left Parietal'};
