...
groups={[1 3 5];[2 4 6];[11 13 14];[7 8 9 10]}; % removed 12 as StO2 outlier
grouplabels={'Calibration block';'Check block';'Left Forehead';'Right Forehead'};
