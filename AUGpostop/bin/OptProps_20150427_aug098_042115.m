...
groups={[1 3 5];[2 4 6];[12 13 14 15];[7 8 9 10 11];[16 17 18 19]};
grouplabels={'Calibration block';'Check block';'Left Forehead';'Right Forehead';'Right Parietal'};
