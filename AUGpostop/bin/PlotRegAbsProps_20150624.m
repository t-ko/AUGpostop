...
AVG_BFIright = [];
AVG_BFIleftparietal = [];
AVG_BFIrightparietal = [];
AVG_StO2left = [];
AVG_StO2right = [];
AVG_StO2leftparietal = [];
AVG_StO2rightparietal = [];
AVG_THCleft = [];
AVG_THCright = [];
AVG_THCleftparietal = [];
AVG_THCrightparietal = [];
...
for sID = 1:length(ALLstudyIDs)
    ...
    % Patient-Averaged
    AVG_BFIleft = [AVG_BFIleft nanmean(BFIleft)];
    AVG_BFIright = [AVG_BFIright nanmean(BFIright)];
    AVG_BFIleftparietal = [AVG_BFIleftparietal nanmean(BFIleftparietal)];
    AVG_BFIrightparietal = [AVG_BFIrightparietal nanmean(BFIrightparietal)];
    AVG_StO2left = [AVG_StO2left nanmean(StO2left)];
    AVG_StO2right = [AVG_StO2right nanmean(StO2right)];
    AVG_StO2leftparietal = [AVG_StO2leftparietal nanmean(StO2leftparietal)];
    AVG_StO2rightparietal = [AVG_StO2rightparietal nanmean(StO2rightparietal)];
    AVG_THCleft = [AVG_THCleft nanmean(THCleft)];
    AVG_THCright = [AVG_THCright nanmean(THCright)];
    AVG_THCleftparietal = [AVG_THCleftparietal nanmean(THCleftparietal)];
    AVG_THCrightparietal = [AVG_THCrightparietal nanmean(THCrightparietal)];
