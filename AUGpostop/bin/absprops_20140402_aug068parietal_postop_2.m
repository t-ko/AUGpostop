...
ylabel('StO2(%)')
xlim([0.5 max([length(StO2_right) length(StO2_left)])+0.5])
set(gca,'XTick',1:max([length(StO2_right) length(StO2_left)]))
%set(gca,'XTick',t)
...
ylabel('StO2(%)')
xlim([0.5 max([length(StO2_rightparietal) length(StO2_leftparietal)])+0.5])
set(gca,'XTick',1:max([length(StO2_rightparietal) length(StO2_leftparietal)]))
%set(gca,'XTick',t)
xlabel('Repetition No.')
grid on
ylim([35 90])
