...
if usedISS
    ...
    i=filenum;
        ...
        fname=['../svo2test/svo2test_' patdate '/' patID '/Data_' patdate names(i,:) '.txt'];
        fid = fopen([ fname ], 'r');
        if usednewsettings
 ...
 elseif appliedcalibration
    ...
    maxwindows(gcf)
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/ISSTimes_' patID '_' patdate ext '.fig'],'fig')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/ISSTimes_' patID '_' patdate ext '.jpg'],'jpg')
    ...
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/Amplitude_' patID '_' patdate ext '.fig'],'fig')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/Amplitude_' patID '_' patdate ext '.jpg'],'jpg')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/Amplitude_' patID '_' patdate ext '.eps'],'epsc2')
    ...
    grid on
    set(gcf,'PaperPositionMode','Auto')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/Phase_' patID '_' patdate ext '.fig'],'fig')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/Phase_' patID '_' patdate ext '.jpg'],'jpg')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/Phase_' patID '_' patdate ext '.eps'],'epsc2')
    
    figure,plot(phasestd)
    xlabel('Frame')
    ylabel('\sigma_{Phase}')
    ylim([0 50])

    figure,plot(AC./ACstd)
    xlabel('Frame','FontSize',25)
    ylabel('SNR (Amp)','FontSize',25)
    set(gca,'FontSize',25)
    axis tight
    grid on
    set(gcf,'PaperPositionMode','Auto')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/AmplitudeSNR_' patID '_' patdate ext '.fig'],'fig')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/AmplitudeSNR_' patID '_' patdate ext '.jpg'],'jpg')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/AmplitudeSNR_' patID '_' patdate ext '.eps'],'epsc2')
...
sdlist(1,1)=2.5;
    ...
    maxwindows(gcf)
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/mua_' patID '_' patdate ext '.fig'],'fig')
    saveas(gcf,['../svo2test/svo2test_' patdate '/' patID '/savedfigs/mua_' patID '_' patdate ext '.jpg'],'jpg')
